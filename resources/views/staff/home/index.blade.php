        ...
        <div class="row align-items-center">
            <div class="col-lg-6 hero-content">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <a href="{{ route('staff.posts.home') }}" class="btn btn-light btn-lg">
...
<section class="py-5">
    <div class="container">
                ...
                <div class="card post-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('staff.posts.show', $post->id) }}" class="btn btn-outline-primary btn-sm">
                                Đọc tiếp
                            </a>
                        </div>
                    </div>
        ...
        <div class="text-center mt-4">
            <a href="{{ route('staff.posts.home') }}" class="btn btn-primary">
    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                @auth
                    <a href="{{ route('staff.posts.home') }}" class="btn btn-light btn-lg me-3">
