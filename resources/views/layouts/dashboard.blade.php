...
<div class="flex h-screen bg-gray-100">
    ...
    <aside class="hidden lg:flex flex-col w-64 bg-white border-r border-gray-200 shadow-lg z-2">
        ...
        <div class="p-4 border-t border-gray-200">
            <div class="flex items-center gap-3 p-3 rounded-lg bg-gray-50">
                ...
                <button class="h-8 w-8 flex items-center justify-center rounded-xl cursor-pointer hover:text-red-600 hover:bg-red-200">
                    ⏻
                </button>
            </div>
        </div>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        {{-- Header --}}
        <header class="bg-white border-b border-gray-200 px-6 py-2 flex items-center justify-between shadow-md z-2">
            <h1 class="text-lg font-bold text-gray-900">Dashboard</h1>
            <button class="p-3 rounded-2xl hover:bg-[#f0fdf4] cursor-pointer">
