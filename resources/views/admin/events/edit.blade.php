    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8 col-xl-6">
            <div class="card shadow-soft">
                <div class="card-body">
                    <h2 class="h4 mb-4">🆕 Sửa sự kiện</h2>
                    <form method="POST" action="{{ route('admin.events.update', $event->id) }}">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="register_date" value="{{ old('register_date', $event->register_date) }}" required class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="register_end_date" value="{{ old('register_end_date', $event->register_end_date) }}" required class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="event_start_date" value="{{ old('event_start_date', $event->event_start_date) }}" required class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="event_end_date" value="{{ old('event_end_date', $event->event_end_date) }}" required class="form-control">
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="participants" value="{{ old('participants', $event->participants) }}" required class="form-control">
                        ...
                        <div class="mb-3 mt-1">
                            ...
                            <input type="text" name="description" value="{{ old('description', $event->description) }}" required class="form-control">
