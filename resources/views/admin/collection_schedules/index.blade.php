            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div class="relative w-full md:w-1/2">
                    ...
                    <input type="text" placeholder="Tìm kiếm..."
                        class="w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-400 focus:outline-none" />
                </div>
                    ...
                    <tbody class="text-sm divide-y divide-gray-100">
                        @foreach ($collectionSchedules as $collectionSchdule)
                            <tr class="hover:bg-green-50">
                                ...
                                <td class="py-3 px-4">
                                    {{ \Carbon\Carbon::parse($collectionSchdule->scheduled_date)->format('Y-m-d') }}</td>
            ...
            <div id="modal"
              ...
              transform opacity-0 translate-y-5 scale-95 transition-all duration-300">
                    ...
                    <form class="space-y-4" action="{{ route('admin.collection-schedules.store') }}" method="POST">
                        ...
                        <div class="">
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Ngày: <span
                                        class="text-red-500">*</span></label>
                        ...
                        <div class="flex justify-end gap-3 pt-3">
                            ...
                            <button type="submit"
                                class="px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg cursor-pointer">Lưu</button>
                        </div>
                    </form>
                </div>
            </div>
