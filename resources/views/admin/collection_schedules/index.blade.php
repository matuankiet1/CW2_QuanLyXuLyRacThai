                        ...
                        <form action="{{ route('admin.collection-schedules.search') }}" method="GET" class="relative w-full">
                            <div class="relative w-full flex items-center">
                                ...
                                <input type="text" name="q" value="{{ request('q') }}"
                                    placeholder="Tìm kiếm (Nhân viên thực hiện, ngày thu gom)" class="w-full pl-11 pr-3 py-2 rounded-xl border border-gray-300
                                    ...
                                    <td class="py-3 px-4 text-center">
                                        <div class="flex items-center justify-center">
                                            ...
                                            <button data-id="{{ $collectionSchedule->schedule_id }}"
                                                class="viewReportBtn group inline-flex items-center justify-center hover:bg-blue-200 rounded-xl mx-1 p-2 transition cursor-pointer"
                                                aria-label="Xem báo cáo" data-modal="view-report">

                                                <svg class="w-5 h-5 group-hover:text-blue-600" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <script>
                                                document.querySelectorAll('.viewReportBtn').forEach(button => {
                                                    button.addEventListener('click', function () {
                                                        ...
                                                        // Sử dụng route helper của Laravel để sinh URL chuẩn
                                                        const url = "{{ route('admin.waste_logs.index') }}?schedule_id=" + scheduleId;
                                            ...
                                            <button id="{{ $collectionSchedule->schedule_id }}"
                                                ...
                                                aria-label="Xóa">
                                                {{-- Icon xóa --}}
                                                <svg class="w-5 h-5 group-hover:text-red-600" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 24 24" color="#000" fill="none">
                                                    <path
                                                        d="M19.5 5.5L18.8803 15.5251C18.7219 18.0864 18.6428 19.3671 18.0008 20.2879C17.6833 20.7431 17.2747 21.1273 16.8007 21.416C15.8421 22 14.559 22 11.9927 22C9.42312 22 8.1383 22 7.17905 21.4149C6.7048 21.1257 6.296 20.7408 5.97868 20.2848C5.33688 19.3626 5.25945 18.0801 5.10461 15.5152L4.5 5.5"
        ...
        @endif
            ...
            <div id="modal"
                ...
                <div class="flex items-center justify-center w-full h-full">
                    <div id="modalBox" class="bg-white backdrop-blur-md border border-green-100 shadow-xl rounded-xl p-6 max-w-md w-full
                        ...
                        <form class="space-y-4" action="{{ route('admin.collection-schedules.store') }}" method="POST">
                            ...
                            <div class="status-field">
                                ...
                                <select id="selectStatus" name="status"
                                    ...
                                    <option value="Chưa thực hiện" selected {{ old('status', 'Chưa thực hiện') === 'Chưa thực hiện' ? 'selected' : '' }}>
