...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Thêm Banner Mới</h1>
            <p class="text-gray-600 mt-1">Tạo mới banner quảng cáo hiển thị trên website</p>
        </div>
        ...
        <label for="image" class="file-upload-label cursor-pointer">
            <div class="file-upload-content">
                ...
                <div class="file-upload-text">
                    <p class="text-lg font-medium text-gray-900">Chọn hình ảnh</p>
    ...
    @enderror
            ...
            <div class="mb-5">
                ...
                <select id="position" name="position"
                    class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500">
                    <option value="top">Trang chủ - Top</option>
