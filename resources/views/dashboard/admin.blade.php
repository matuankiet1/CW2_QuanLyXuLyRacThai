@extends('layouts.app') {{-- nếu bạn có layout chính, hoặc bỏ dòng này nếu không --}}
@section('content')
<div class="space-y-6 p-6">

    {{-- ✅ Overview Cards --}}
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="p-6 border-l-4 border-l-green-500 bg-white rounded-lg shadow">
        ...
        <div class="p-6 border-l-4 border-l-emerald-500 bg-white rounded-lg shadow">
        ...
        <div class="p-6 border-l-4 border-l-teal-500 bg-white rounded-lg shadow">
        ...
        <div class="p-6 border-l-4 border-l-cyan-500 bg-white rounded-lg shadow">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-4 mt-1 text-xs text-gray-500">
                                <span>{{ $student['points'] }} điểm</span>
                                <span>•</span>
                                <span>{{ $student['waste'] }} kg</span>
                            </div>
                        </div>
                        <div class="w-32">
